        ...
        icon.onclick = function() {
            ...
            if (entry) {
                const fields = [
                    ...
                    { label: 'PWT', value: entry.pwt }, // Added PWT field
...
function downloadCombinedPDF(reports, fromDate, toDate) {
    ...
    const win = window.open('', '', 'width=900,height=700');
    win.document.write('<html><head><title>PDF Export</title>');
    win.document.write('<style>body{font-family:sans-serif;}table{border-collapse:collapse;width:100%;}th,td{border:1px solid #888;padding:8px;text-align:center;}th{background:#eaf1fb;}h3{margin:18px 0 6px 0;} .summary-table{margin-bottom:24px;border-radius:12px;box-shadow:0 2px 8px #43cea222;} .summary-table th{background:#eaf1fb;color:#185a9d;} .summary-table td{background:#f3f6fa;}</style>');
    win.document.write('</head><body>');
